...
const ResizablePanelGroup = ({ className, direction = "horizontal", ...props }) => ((0, jsx_runtime_1.jsx)(ResizablePrimitive.PanelGroup, { className: (0, utils_1.cn)("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className), direction: direction, ...props }));
