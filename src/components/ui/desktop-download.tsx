...
const DesktopDownload: React.FC<DesktopDownloadProps> = ({ variant = 'compact', className = '' }) => {
  ...
  const handleDownload = async (platform: string) => {
    ...
    // Use GitHub releases for reliable downloads - v1.0.22-unsigned with FIXED environment variables
    const downloadFiles = {
      windows: `https://github.com/mafatah/time-flow-admin/releases/download/v1.0.22-unsigned/Ebdaa Work Time Setup 1.0.22.exe`,
      'mac-intel': `https://github.com/mafatah/time-flow-admin/releases/download/v1.0.22-unsigned/Ebdaa-Work-Time-1.0.22-Intel.dmg`, // FIXED configuration loading
      'mac-arm': `https://github.com/mafatah/time-flow-admin/releases/download/v1.0.22-unsigned/Ebdaa-Work-Time-1.0.22-arm64.dmg`, // FIXED configuration loading
      'mac': `https://github.com/mafatah/time-flow-admin/releases/download/v1.0.22-unsigned/Ebdaa-Work-Time-1.0.22-arm64.dmg`, // Default to ARM64 for modern Macs
      linux: `https://github.com/mafatah/time-flow-admin/releases/download/v1.0.22-unsigned/Ebdaa Work Time-1.0.22.AppImage`
    };
